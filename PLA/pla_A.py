...
#读取测试数据
test = pd.read_csv('/home/wx/machine-learning-exercises/machine-learning-ex1/ex1/PLA_a/test_data.csv', header=None)
x = test.iloc[1:,:].values
x = x.astype(float)
tlabel = pd.read_csv('/home/wx/machine-learning-exercises/machine-learning-ex1/ex1/PLA_a/test_label.csv', header=None)
